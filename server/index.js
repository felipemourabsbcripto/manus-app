...
app.post('/api/funcionarios', (req, res) => {
  ...
  const id = uuidv4();
  db.prepare(`
    INSERT INTO funcionarios (id, nome, email, telefone, whatsapp, cargo, especialidade, crm, tipo, gestor_id, salario_hora) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  `).run(id, nome, email, telefone, whatsappNum || telefone, cargo, especialidade, crm, tipo || 'medico', gestor_id, salario_hora || 0);
